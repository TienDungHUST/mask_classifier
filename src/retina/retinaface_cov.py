...
from retina.rcnn.processing.bbox_transform import clip_boxes
from retina.rcnn.processing.generate_anchor import generate_anchors_fpn, anchors_plane
from retina.rcnn.processing.nms import gpu_nms_wrapper, cpu_nms_wrapper
from retina.rcnn.processing.bbox_transform import bbox_overlaps
...
class RetinaFaceCoV:
    ...
    def detect(self, img, threshold=0.96, scales=[1.0], do_flip=False):
